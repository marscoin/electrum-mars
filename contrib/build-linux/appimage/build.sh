...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="$CONTRIB_APPIMAGE/fresh_clone/electrum-mars" && \
...
sudo docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-mars \
    --rm \
    --workdir /opt/electrum-mars/contrib/build-linux/appimage \
