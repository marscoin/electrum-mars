...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        (os.path.join('share', 'applications'),               ['electrum-mars.desktop']),
        (os.path.join('share', 'pixmaps'),                    ['electrum_mars/gui/icons/electrum-mars.png']),
        (os.path.join('share', 'icons/hicolor/128x128/apps'), ['electrum_mars/gui/icons/electrum-mars.png']),
    ]
...
setup(
    ...
    packages=(['electrum_mars',]
              + [('electrum_mars.'+pkg) for pkg in
                 find_packages('electrum_mars', exclude=["tests", "gui.kivy", "gui.kivy.*"])]),
    package_dir={
    ...
    license="MIT Licence",
    url="https://github.com/marscoin/electrum-mars",
