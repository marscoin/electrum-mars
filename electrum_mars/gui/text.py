...
from electrum_mars.gui import BaseElectrumGui
from electrum_mars import util
from electrum_mars.util import format_satoshis, format_time
from electrum_mars.util import EventListener, event_listener
from electrum_mars.bitcoin import is_address, address_to_script, COIN
from electrum_mars.transaction import PartialTxOutput
from electrum_mars.wallet import Wallet, Abstract_Wallet
from electrum_mars.wallet_db import WalletDB
from electrum_mars.storage import WalletStorage
from electrum_mars.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_mars.interface import ServerAddr
from electrum_mars.invoices import Invoice
from electrum_mars.invoices import PR_DEFAULT_EXPIRATION_WHEN_CREATING

if TYPE_CHECKING:
    from electrum_mars.daemon import Daemon
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def __init__(self, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-mars create'")
            exit()
