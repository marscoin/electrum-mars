...
from electrum_mars.util import is_valid_email
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_mars.mnemonic import Mnemonic
        from electrum_mars.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_mars.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
