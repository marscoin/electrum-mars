...
from electrum_mars.util import base_units_list
from electrum_mars.i18n import languages
from electrum_mars.gui.kivy.i18n import _
from electrum_mars.plugin import run_hook
from electrum_mars import coinchooser
...
#:import messages electrum_mars.gui.messages
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Marscoin amounts.")
