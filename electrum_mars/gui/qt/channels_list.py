...
from electrum_mars.util import bh2u, NotEnoughFunds, NoDynamicFeeEstimates
from electrum_mars.i18n import _
from electrum_mars.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState
from electrum_mars.wallet import Abstract_Wallet
from electrum_mars.lnutil import LOCAL, REMOTE, format_short_channel_id, LN_MAX_FUNDING_SAT
from electrum_mars.lnworker import LNWallet
...
class ChannelsList(MyTreeView):
    ...
    def new_channel_dialog(self):
        ...
        if self.parent.network.channel_db:
            ...
            from electrum_mars.lnworker import hardcoded_trampoline_nodes
