...
from electrum_mars.util import InvoiceError
from electrum_mars.invoices import PR_DEFAULT_EXPIRATION_WHEN_CREATING
from electrum_mars.invoices import PR_EXPIRED, pr_expiration_values
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        self.receive_tabs.addTab(self.receive_address_widget, read_QIcon("marscoin_32x32.png"), _('Address'))
        # Lightning tab removed — Marscoin does not use Lightning Network
