...
from electrum_mars.i18n import set_language, languages
from electrum_mars.plugin import run_hook
from electrum_mars.util import (profiler)
...
class ElectrumGui(Logger):
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        self.app.engine.load('electrum_mars/gui/qml/components/main.qml')
