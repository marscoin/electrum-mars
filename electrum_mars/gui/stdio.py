...
from electrum_mars import WalletStorage, Wallet
from electrum_mars.wallet import Abstract_Wallet
from electrum_mars.wallet_db import WalletDB
from electrum_mars.util import format_satoshis, EventListener, event_listener
from electrum_mars.bitcoin import is_address, COIN
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Marscoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-mars setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-mars setconfig' to change your settings")
        return True
