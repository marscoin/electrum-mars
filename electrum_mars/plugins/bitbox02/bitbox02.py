...
from electrum_mars import bip32, constants
from electrum_mars.i18n import _
from electrum_mars.keystore import Hardware_KeyStore
from electrum_mars.transaction import PartialTransaction
from electrum_mars.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_mars.util import bh2u, UserFacingException
from electrum_mars.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_mars.logging import get_logger
from electrum_mars.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_mars.simple_config import SimpleConfig
from electrum_mars.json_db import StoredDict
from electrum_mars.storage import get_derivation_used_for_hw_device_encryption
from electrum_mars.bitcoin import OnchainOutputType

import electrum_mars.bitcoin as bitcoin
import electrum_mars.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TMARS
        return bitbox02.btc.MARS
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.MARS:
    ...
    def _get_coin(self):
        return bitbox02.btc.TMARS if constants.net.TESTNET else bitbox02.btc.MARS
