...
from electrum_mars.util import UserCancelled, UserFacingException
from electrum_mars.keystore import bip39_normalize_passphrase
...
from electrum_mars.plugin import runs_in_hwd_thread
from electrum_mars.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the marscoins in the wallet.").format(self.device)
        else:
