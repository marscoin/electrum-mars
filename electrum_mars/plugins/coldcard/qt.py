...
from electrum_mars.gui.qt.util import (WindowModalDialog, CloseButton, Buttons, getOpenFileName,
                                      getSaveFileName)
from electrum_mars.gui.qt.transaction_dialog import TxDialog
