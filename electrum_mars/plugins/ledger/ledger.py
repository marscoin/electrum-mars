...
from electrum_mars import ecc, constants
from electrum_mars import bip32
from electrum_mars.crypto import hash_160
from electrum_mars.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
...
from electrum_mars.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_mars.wallet import Standard_Wallet
from electrum_mars.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_mars.base_wizard import ScriptTypeNotSupported
from electrum_mars.logging import get_logger
from electrum_mars.plugin import runs_in_hwd_thread, Device
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Marscoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Marscoin mode")) from e
                raise e
