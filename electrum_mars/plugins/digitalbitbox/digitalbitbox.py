...
from electrum_mars.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_mars.bitcoin import public_key_to_p2pkh
from electrum_mars.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_mars import ecc
from electrum_mars.ecc import msg_magic
from electrum_mars.wallet import Standard_Wallet
from electrum_mars import constants
from electrum_mars.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_mars.i18n import _
from electrum_mars.keystore import Hardware_KeyStore
from electrum_mars.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_mars.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_mars.network import Network
from electrum_mars.logging import get_logger
from electrum_mars.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-MARS-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
