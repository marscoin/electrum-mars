...
from electrum_mars.util import print_msg, create_and_start_event_loop
from electrum_mars.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <marscoin_address>")
    sys.exit(1)
