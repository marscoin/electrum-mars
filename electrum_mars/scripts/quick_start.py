...
from electrum_mars.wallet import Wallet, create_new_wallet
from electrum_mars.wallet_db import WalletDB
from electrum_mars.commands import Commands
from electrum_mars.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-mars/testnet as datadir
