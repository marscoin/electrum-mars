...
from electrum_mars import constants, blockchain
from electrum_mars.simple_config import SimpleConfig
from electrum_mars.blockchain import Blockchain, deserialize_header, hash_header
from electrum_mars.util import bh2u, bfh, make_dir
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for Marscoin block header #100.
