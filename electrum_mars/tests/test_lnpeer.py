...
import electrum_mars.trampoline
...
from electrum_mars.ecc import ECPrivkey
from electrum_mars import simple_config, lnutil
from electrum_mars.lnaddr import lnencode, LnAddr, lndecode
from electrum_mars.bitcoin import COIN, sha256
from electrum_mars.util import bh2u, NetworkRetryManager, bfh, OldTaskGroup, EventListener
from electrum_mars.lnpeer import Peer
from electrum_mars.lnutil import LNPeerAddr, Keypair, privkey_to_pubkey
from electrum_mars.lnutil import PaymentFailure, LnFeatures, HTLCOwner
from electrum_mars.lnchannel import ChannelState, PeerState, Channel
from electrum_mars.lnrouter import LNPathFinder, PathEdge, LNPathInconsistent
from electrum_mars.channel_db import ChannelDB
from electrum_mars.lnworker import LNWallet, NoPathFound
from electrum_mars.lnmsg import encode_msg, decode_msg
from electrum_mars import lnmsg
from electrum_mars.logging import console_stderr_handler, Logger
from electrum_mars.lnworker import PaymentInfo, RECEIVED
from electrum_mars.lnonion import OnionFailureCode
from electrum_mars.lnutil import derive_payment_secret_from_payment_preimage, UpdateAddHtlc
from electrum_mars.lnutil import LOCAL, REMOTE
from electrum_mars.invoices import PR_PAID, PR_UNPAID
from electrum_mars.interface import GracefulDisconnect
    ...
    def test_reestablish_replay_messages_rev_then_sig(self):
        ...
        async def f():
            ...
            async with OldTaskGroup() as group:
                await group.spawn(p1._message_loop())
                await group.spawn(p2._message_loop())
                with self.assertLogs('electrum_mars', level='INFO') as logs:
