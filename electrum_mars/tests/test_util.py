...
from electrum_mars.util import (format_satoshis, format_fee_satoshis, parse_URI,
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_invalid_address(self):
        self.assertRaises(BaseException, parse_URI, 'marscoin:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI, 'notmarscoin:LectrumELqJWMECz7W2iarBpT4VvAPqwAv')

    def test_parse_URI_parameter_polution(self):
        self.assertRaises(Exception, parse_URI, 'marscoin:LectrumELqJWMECz7W2iarBpT4VvAPqwAv?amount=0.0003&label=test&amount=30.0')
