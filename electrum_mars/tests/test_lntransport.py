...
from electrum_mars.lnutil import LNPeerAddr
from electrum_mars.lntransport import LNResponderTransport, LNTransport
from electrum_mars.util import OldTaskGroup
