...
from electrum_mars.wallet_db import FINAL_SEED_VERSION
from electrum_mars.wallet import (Abstract_Wallet, Standard_Wallet, create_new_wallet,
                                 restore_wallet_from_text, Imported_Wallet, Wallet)
from electrum_mars.exchange_rate import ExchangeBase, FxThread
from electrum_mars.util import TxMinedInfo, InvalidPassword
...
class TestCreateRestoreWallet(WalletTestCase):
    ...
    def test_restore_wallet_from_text_mnemonic(self):
        ...
        self.assertEqual(encrypt_file, wallet.storage.is_encrypted())
        self.assertEqual('mars1q2ccr34wzep58d4239tl3x3734ttle92arvely7', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_addresses(self):
        text = 'mars1q2ccr34wzep58d4239tl3x3734ttle92arvely7 mars1qnp78h78vp92pwdwq5xvh8eprlga5q8gu7xl7hg'
        ...
        wallet.delete_address('mars1qnp78h78vp92pwdwq5xvh8eprlga5q8gu7xl7hg')
    ...
    def test_restore_wallet_from_text_privkeys(self):
        ...
        self.assertEqual('mars1q2ccr34wzep58d4239tl3x3734ttle92arvely7', addr0)
