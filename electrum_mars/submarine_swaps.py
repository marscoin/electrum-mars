...
API_URL_MAINNET = 'https://swaps.electrum-mars.org/api'
API_URL_TESTNET = 'https://swaps.electrum-mars.org/testnet'
...
class SwapManager(Logger):
    ...
    async def normal_swap(
        ...
        """send on-chain MARS, receive on Lightning
    ...
    async def get_pairs(self) -> None:
        ...
        fees = pairs['pairs']['MARS/MARS']['fees']
        ...
        limits = pairs['pairs']['MARS/MARS']['limits']
